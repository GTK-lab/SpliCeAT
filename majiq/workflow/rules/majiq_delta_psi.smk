rule majiq_delta_psi:
    ...
    output:
        config["BASE_PATH"]+"/results/majiq_delta_psi/{experiment}/ctr-cko.deltapsi.tsv"
    params:
    ...
    threads:
        16
    shell:
        "majiq deltapsi -grp1 {params.grp1} -grp2 {params.grp2} -j {threads} -o {params.out} -n ctr cko"